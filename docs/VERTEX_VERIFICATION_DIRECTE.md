...
2. **[bloquant]** reproduit à l'identique, trois fois, avec arithmétique exacte. 1) MESURE HTTP (instance QA 5003) `curl -s http://127.0.0.1:5003/api/portfolio/context` → `"total_value":4256.59, "hhi":0.7005, "top_symbol":"MSFT", "top_weight_pct":8
...
26. **[majeur]** sur l'instance de contrôle 5003, API + page rendue. Je n'ai pas pu le réfuter ; j'ai même trouvé une preuve plus dure que celle avancée. 1) Mesure API (POST http://127.0.0.1:5003/api/portfolio/team, KO 1×88,07 + 2 options + 25 000
